...
kubectl expose Deployment scale-test --target-port 4000 --name scale-test --type=LoadBalancer --port 4000;
...
kubectl autoscale Deployment scale-test --min=1 --max=5 --cpu-percent=10;
...
kubectl delete Deployment scale-test --grace-period=0 --force;
