...
k3s kubectl scale ReplicaSet stress-test --replicas=5;
...
k3s kubectl scale ReplicaSet stress-test --replicas=10;
...
k3s kubectl scale ReplicaSet stress-test --replicas=20;
