...
for v1 in ${variants1[@]}; do
  for v2 in ${variants2[@]}; do
    for s in ${series[@]}; do
      ...
      endTime=$(k3s kubectl logs --all-containers=true -l app=test-deployment | sort -r | head -n 1);
      ...
      cleanUpResult=`k3s kubectl logs --all-containers=true -l app=test-deployment | sort -r | head -n 1 | grep "not found"`;
